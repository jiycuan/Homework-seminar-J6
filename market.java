...
public class market {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Объём оперативной пямяти (указать в виде целого числа, символизирующего количество гигабайтов): ");
        user_n.RAM = in.nextInt();
        System.out.println("Объём пямяти видеокарты (указать в виде целого числа, символизирующего количество гигабайтов): ");
        user_n.VC = in.nextInt();
        System.out.println("Объём жесткого диска (указать в виде целого числа, символизирующего количество гигабайтов): ");
